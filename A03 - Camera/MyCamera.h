...
namespace Simplex
{
	...
	public:
		...
		*/
		...
		/*
		USAGE: Adjust the pitch of the camera
		ARGUMENTS: float axFloatY -> amount of rotation
		OUTPUT: ---
		*/
		void changePitch(float xFloatY);
		/*
		USAGE: Adjust the yaw of the camera
		ARGUMENTS: float xFloatX -> amount of rotation
		OUTPUT: ---
		*/
		void changeYaw(float xFloatX);
	};
